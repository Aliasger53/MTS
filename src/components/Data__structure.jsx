...
const resource__data = [
  ...
  {
    name: "Certifications",
    name2: "Certifications",
    link: "#",
    description:
      "Outsourcing help companies to focus on their core activities and also achieve high level of compliance. We provide accounting outsourcing services for Tally and Quick Books as well.",
    icon: <TbCertificate className="icon" />,
  },
];
...
const contact__list = [
  {
    href: "tel:+919930999252",
    icon: <BiPhoneCall />,
    text: "+91 99309 99252",
  },
  {
    href: "https://wa.me/+919930999252",
    icon: <BsWhatsapp />,
    text: "WhatsApp",
  },
  {
    href: "mailto:machinetoolssyndicate@gmail.com",
    icon: <MdOutlineEmail />,
    text: "machinetoolssyndicate@gmail.com",
  },
  {
    href: "#",
    icon: <BsLinkedin />,
